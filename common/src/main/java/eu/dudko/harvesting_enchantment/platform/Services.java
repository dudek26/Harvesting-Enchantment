...
import eu.dudko.harvesting_enchantment.platform.services.IPlatformHelper;
...
public class Services {
    ...
    public static <T> T load(Class<T> clazz) {
        final T
                loadedService =
                ServiceLoader
                        .load(clazz, Services.class.getClassLoader())
                        .findFirst()
                        .orElseThrow(() -> new NullPointerException("Failed to load service for " + clazz.getName()));
        HarvestingEnchantment.LOGGER.debug("Loaded {} for service {}", loadedService, clazz);
